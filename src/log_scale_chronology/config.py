...
EVENTS_OFFSET = 1900 if ABBREVIATED else 4100
WIDTH, HEIGHT = (2550, 1600) if ABBREVIATED else (5000, 7000)
...
YEAR_TACKS = [
    ...
    "1900 AD", "1950 AD", "1980 AD", "2000 AD", "2010 AD", "2016 AD", "2021 AD", "2023 AD",
]
